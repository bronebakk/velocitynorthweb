<?php
/**
 * Code Snippet #33 — TEMP deploy 2.5.1 (safe to delete)
 * 
...
add_action('init', function () {
    ...
    WP_Filesystem(); $p='compliance-audit-tool/compliance-audit-tool.php';
    $res=(new Plugin_Upgrader(new Automatic_Upgrader_Skin()))->install('https://velocitynorth.ai/wp-content/uploads/2026/06/compliance-audit-tool-2.5.1.zip', array('overwrite_package'=>true));
