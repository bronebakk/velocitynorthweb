<?php
/**
 * Code Snippet #5 — Velocity North — site chrome (header/footer/no-sidebar)
 * Terminal-style header + dark footer + hides default sidebar across all pages.
 * scope: site-css | active: False | priority: 10
 *
